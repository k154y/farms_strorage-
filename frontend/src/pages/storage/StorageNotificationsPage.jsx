...
export default function StorageNotificationsPage() {
  const user = getUser();
  ...
  return (
    <div className="rounded-2xl bg-white p-6 shadow-sm">
      <h2 className="text-2xl font-bold text-slate-900">Storage Manager Notifications</h2>
      <p className="mt-2 text-slate-500">
        Stay updated on booking activity, facility updates, and document review feedback from admin.
      </p>
